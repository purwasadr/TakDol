...
@section('container')
    ...
    <h4 class="mt-4 mb-5">My Orders</h4>
                ...
                <div class="list-group-item list-group-item-action">
                    <div class="row">
                        ...
                        <div class="col-2 d-inline">
                            ...
                            <form action="/seller/myorders/edit-status"
                                method="POST"
                                class="d-inline">
                                @csrf
                                <input type="hidden"
                                ...
                                @switch($order->status->id)
                                    @case(1)
                                        <input type="hidden"
                                            ...
                                            value="2">
                                        <button type="submit"
                                            class="btn btn-sm text-decoration-none">Process</button>
                                    @break
                                    @case(2)
                                        <input type="hidden"
                                            name="status"
                                            value="3">
                                        <button type="submit"
                                            class="btn btn-sm text-decoration-none">On Ship</button>
                                        @default
                            ...
                            <a href=""
                                class="text-decoration-none">Cancel</a>
                        </div>
                    </div>
                </div>
            @endforeach
